...
//
// curl -F 'blue-dot=@sample-files/blue.gif' http://localhost:8000
//
// curl -F 'green-dot=@sample-files/green.gif' http://localhost:8000
//
// curl -F 'avatar=@sample-files/profile.gif' http://localhost:8000
//
//
// You can even send multiple files and fields at the same time:
//
//
// curl -F name=luciano -F avatar=@sample-files/profile.gif -F favourite_color=@sample-files/blue.gif http://localhost:8000
//
